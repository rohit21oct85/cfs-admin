...
export default function QAData() {
    ...
    const handleQandA = async (e) => {
        ...
        if(params?.status == "false"){
            ...
            response = await axios.get(`https://www.crazyforstudy.com/api/get-question-and-answer.php?accessKey=crazyforstudy&id=${params?.chield_subject_id}&page=${page}`);    
                        ...
                        <div style={{ height: '400px', overflowY: 'scroll', overflowX: 'hidden'}}>
                            {params?.status === "true" && questions?.map(question => {
                                ...
                                <div className="col-md-12 row table-bordered border-right mt-2 ml-1 pl-2" key={question?.uuid} id={question?.uuid}>
                                    ...
                                    <div className="col-md-11 pl-0" dangerouslySetInnerHTML={{__html: `${renderHTML(question?.question)}`}} />
