            ...
            <div className="dashboard_main-container">
                ...
                <div className="dash-cont-start">
                    <div className="org-main-area">
                        ...
                        <Form method="POST" className="col-md-12 p-0" encType="multipart/form-data">
                                ...
                                {params.subject_name ? (
                                    ...
                                    onChange={ 
                                        event => {
                                            ...
                                            history.push(`/books-create/${subject_name.trim().replace(' ','-').toLowerCase()}/${subject_id}`)
                                        }
                                    } >
                            ...
                            <Form.Group>
                                ...
                                <input type="text" autoComplete="off" className="form-control" name="BookName"/>
                            </Form.Group>
                            
                            <Form.Group>
                                <Form.Label>Book Name Edition</Form.Label>
                                <input type="text" autoComplete="off" className="form-control" name="BookNameEdition"/>
                            </Form.Group>
                                    
                            <Form.Group>
                                <Form.Label>Edition</Form.Label>
                                <input type="text" autoComplete="off" className="form-control" name="Edition"/>
                            </Form.Group>
